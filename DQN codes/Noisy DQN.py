...
###
# Noise DQNAgent 1 code
# Noise DQNAgent 2 code
class DQNAgent2:
...
dqn_agent=DQNAgent2(no_states,no_actions,no_layer,Learning_rate,no_neurons,no_epoch)
successful_trials =[]
# Training loop
state_lst=[]
batch_size = 32
...
dqn_agent_with_noise1 = dqn_agent
# Training loop
state_lst=[]
batch_size = 32
time_range = 500
...
algorithm_rewards = [
    dqn_agent_with_noise1.total_reward_lst  # Algorithm 1 rewards

]
print(dqn_agent_with_noise1.total_reward_lst)
...
print(successful_trials)
print("size = ")
print(len(history_data_check),len(successful_trials))
