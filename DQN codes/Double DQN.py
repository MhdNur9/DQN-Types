...
class Double_DQNAgent:
    ...
    def reward_cal(self, state_id, action, distance_error, next_state_id,collusion):
        ...
        if abs(self.distance_error) <= abs(distance_error):
            ...
            new_reward_step = new_reward_step + 0.3
...
dqn_agent = Double_DQNAgent(no_states,no_actions,no_layer,Learning_rate,no_neurons,no_epoch)
state_lst = []
error_lst_episode = []
error_episode = []
episode_done_lst = []
...
data_compare_dict = []
data_compare_lst = []
# print(error_lst_episode)
# print("error_lst_episode", type(error_lst_episode), len(error_lst_episode))
# print("error_lst_episode[0]", error_lst_episode[0])
# print("error_lst_episode[-1]", error_lst_episode[-1])
best_distance_error, worst_distance_error = plot_distance_error(error_lst_episode)
# print("best_distance_error")
# print(best_distance_error)
# print("worst_distance_error")
# print(worst_distance_error)
# print("episode_done_lst", episode_done_lst)
# plt.plot(episode_done_lst, label='espisodes to successful throwing')
# # Adding labels and legend
# plt.xlabel('Episodes')
# plt.ylabel('nonsuccessful throwing')
# plt.title('espisodes to successful throwing')
# plt.legend()
# # Show plot
# plt.show()
# Data =[[best_distance_error],[worst_distance_error],[episode_done_lst]]
# temp_file = 'temp_file.txt'
# save_list(temp_file, Data)
print("Loss = ")
print(loss)
