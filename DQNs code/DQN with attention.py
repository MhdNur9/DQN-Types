...
Learning_rate = 0.01
no_layer = 32 # 768 layers for the attention layers
num_episodes = 100
no_neurons = 512
no_epoch = 500
...
dqn_agent=DQN_attention_Agent(no_states,no_actions,no_layer,Learning_rate,no_neurons,no_epoch)
# Training loop
batch_size = 8
time_range = 500
total_reward = 0
