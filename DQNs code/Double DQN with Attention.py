...
class Attention_Double_DQNAgent:
    ...
    def replay(self, batch_size):
        ...
        for state, action, reward, next_state, done in minibatch:
            ...
            if not done:
                ...
                target = reward + self.gamma * np.amax(self.target_model.predict(next_state)[0][0][best_action])
...
dqn_agent = Attention_Double_DQNAgent(no_states,no_actions,no_layer,Learning_rate,no_neurons,no_epoch)
...
labels = ['Double DQN with Attention']
